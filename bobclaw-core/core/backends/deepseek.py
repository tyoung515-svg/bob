"""
BoBClaw Core — DeepSeek V4 client (OpenAI-compatible API)

Thin async wrapper around DeepSeek's /v1/* endpoints.
Identical interface to KimiClient for drop-in interchangeability.
"""
...
class DeepSeekClient:
    """Async client for DeepSeek's OpenAI-compatible REST API."""
