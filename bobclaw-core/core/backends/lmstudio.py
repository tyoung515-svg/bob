"""
BoBClaw Core — LM Studio client (OpenAI-compatible API)

Thin async wrapper around LM Studio's /v1/* endpoints.
Identical interface to OllamaClient for drop-in interchangeability.
"""
...
class LMStudioClient:
    ...
    async def health_check(self) -> bool:
        """Return True if LM Studio is reachable and serving models."""
        try:
    ...
    async def list_models(self) -> list[str]:
        """Return a list of model ids loaded in LM Studio."""
        try:
