...
BoB is **v0.98.1** and runs as a **single-operator** application on a machine you
...
v0.98.1 is single-operator and loopback by default. Before you place the gateway
